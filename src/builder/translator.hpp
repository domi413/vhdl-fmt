...
class Translator final
{
  ...
  private:
    ...
    // ========================================================================================
    [[nodiscard]] auto makeConcurrentAssignStatement(vhdlParser::Concurrent_signal_assignment_statementContext *ctx) -> ast::ConcurrentSignalAssignmentStatement;
    [[nodiscard]] auto makeConditionalAssignStatement(vhdlParser::Conditional_signal_assignmentContext *ctx) -> ast::ConcurrentSignalAssignmentStatement;
    [[nodiscard]] auto makeSelectedAssign(vhdlParser::Selected_signal_assignmentContext *ctx) -> ast::ConcurrentSignalAssignmentStatement;
    ...
    [[nodiscard]] auto makeForLoopStatement(vhdlParser::Loop_statementContext *ctx) -> ast::ForLoopStatement;
    ...
    [[nodiscard]] auto makeSimpleExpression(vhdlParser::Simple_expressionContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeRelation(vhdlParser::RelationContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeShiftExpression(vhdlParser::Shift_expressionContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeTerm(vhdlParser::TermContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeFactor(vhdlParser::FactorContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makePrimary(vhdlParser::PrimaryContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeAggregate(vhdlParser::AggregateContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeChoices(vhdlParser::ChoicesContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeChoice(vhdlParser::ChoiceContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeName(vhdlParser::NameContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeRange(vhdlParser::Explicit_rangeContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeTarget(vhdlParser::TargetContext *ctx) -> ast::Expression;
    // [[nodiscard]] auto makeLiteral(vhdlParser::LiteralContext *ctx) -> ast::Expression;
    // [[nodiscard]] auto makeNumericLiteral(vhdlParser::Numeric_literalContext *ctx) -> ast::Expression;
    // [[nodiscard]] auto makePhysicalLiteral(vhdlParser::Physical_literalContext *ctx) -> ast::Expression;
    // [[nodiscard]] auto makeAbstractLiteral(vhdlParser::Abstract_literalContext *ctx) -> ast::Expression;
    // [[nodiscard]] auto makeAllocator(vhdlParser::AllocatorContext *ctx) -> ast::Expression;
    // [[nodiscard]] auto makeCondition(vhdlParser::ConditionContext *ctx) -> ast::Expression;

    // ========================================================================================
    // Expression Name Parts (for building complex names)
    // ========================================================================================
    [[nodiscard]] auto makeFunctionCallOrIndexedNamePart(ast::Expression base, vhdlParser::Function_call_or_indexed_name_partContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeSliceNamePart(ast::Expression base, vhdlParser::Slice_name_partContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeSelectExpr(ast::Expression base, vhdlParser::Selected_name_partContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeAttributeNamePart(ast::Expression base, vhdlParser::Attribute_name_partContext *ctx) -> ast::Expression;
    [[nodiscard]] auto makeAssociationElement(vhdlParser::Association_elementContext *ctx) -> ast::Expression;
    // [[nodiscard]] auto makeNamePart(vhdlParser::Name_partContext *ctx) -> ast::Expression;
    // [[nodiscard]] auto makeSelectedName(ast::Expression base, vhdlParser::Selected_nameContext *ctx) -> ast::Expression;
    // [[nodiscard]] auto makeSelectedNamePart(ast::Expression base, vhdlParser::Selected_name_partContext *ctx) -> ast::Expression;
    ...
    // [[nodiscard]] auto makeIntegerTypeDefinition(vhdlParser::Integer_type_definitionContext *ctx) -> ast::IntegerTypeDefinition;
    // [[nodiscard]] auto makePhysicalTypeDefinition(vhdlParser::Physical_type_definitionContext *ctx) -> ast::PhysicalTypeDefinition;
    // [[nodiscard]] auto makeFloatingTypeDefinition(vhdlParser::Floating_type_definitionContext *ctx) -> ast::FloatingTypeDefinition;
    ...
    // [[nodiscard]] auto makeProtectedTypeDefinition(vhdlParser::Protected_type_definitionContext *ctx) -> ast::ProtectedTypeDefinition;
    ...
    // ========================================================================================
    // Declarative Parts & Statement Parts
    // ========================================================================================
    ...
    // ========================================================================================
    // AMS/Analog Extensions (VHDL-AMS)
    // ========================================================================================
    ...
    // ========================================================================================
    // Operators (rarely need dedicated AST nodes, usually handled as strings)
    // ========================================================================================
