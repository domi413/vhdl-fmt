...
// Labeled loop (not yet verified if supported)
// TEST_CASE("ForLoop: Labeled for loop", "[statements][for_loop]")
// {
//     constexpr std::string_view VHDL_FILE = R"(
//         entity Test is end Test;
//         architecture RTL of Test is
...
//
//     auto design = builder::buildFromString(VHDL_FILE);
//     // TODO: Verify labeled loop support when implemented
// }

// Exit statement in loop (not yet verified if Exit node exists)
// TEST_CASE("ForLoop: For loop with exit statement", "[statements][for_loop]")
// {
//     constexpr std::string_view VHDL_FILE = R"(
//         entity Test is end Test;
//         architecture RTL of Test is
...
//
//     auto design = builder::buildFromString(VHDL_FILE);
//     // TODO: Verify exit statement when implemented
// }

// Next statement in loop (not yet verified if Next node exists)
// TEST_CASE("ForLoop: For loop with next statement", "[statements][for_loop]")
// {
//     constexpr std::string_view VHDL_FILE = R"(
//         entity Test is end Test;
//         architecture RTL of Test is
...
//
//     auto design = builder::buildFromString(VHDL_FILE);
//     // TODO: Verify next statement when implemented
// }
